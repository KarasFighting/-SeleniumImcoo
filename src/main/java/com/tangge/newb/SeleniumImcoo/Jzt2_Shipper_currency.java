 ...
 *货主发布运单
 */
public class Jzt2_Shipper_currency {	
	...
	public static void main(String[] args) throws Exception {
		...
		Jzt2_Shipper_currency jspe =new Jzt2_Shipper_currency();
		jspe.Login();
		 ...
		 */
        //项目名称
        driver.findElement(By.xpath("//*[@id=\"J_Form\"]/div[1]/div[1]/div[2]/table/tbody/tr[1]/td[2]/input")).sendKeys("测试物品脚本");
		Thread.sleep(1000);
        ...
        driver.findElement(By.id("bidValidTime")).click();//投标截止日期输入框
		...
		//收货日期
		 ...
		 driver.findElement(By.xpath("//*[@id=\"receiverOrderAddress\"]/tbody/tr[3]/td[2]/div/input")).sendKeys("2019-10-31");
